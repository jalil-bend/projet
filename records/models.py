...
class MedicalRecord(models.Model):
    ...
    tonometry = models.BooleanField(default=False, verbose_name="Tonometry")
    description_tonometry = models.TextField(blank=True, verbose_name="Description tonometry")
    ...
    test_couleur = models.BooleanField(default=False, verbose_name="Test de couleur")
    description_test_couleur = models.TextField(blank=True, verbose_name="Description test de couleur")
    test_larmes = models.BooleanField(default=False, verbose_name="Test de qualité des larmes")
    description_test_larmes = models.TextField(blank=True, verbose_name="Description test de qualité des larmes")
    
    # Examens optométriques
    acuite_visuelle_brute = models.BooleanField(default=False, verbose_name="Acuité visuelle brute")
    description_acuite_visuelle_brute = models.TextField(blank=True, verbose_name="Description acuité visuelle brute")
    acuite_visuelle_correction = models.BooleanField(default=False, verbose_name="Acuité visuelle avec correction")
    description_acuite_visuelle_correction = models.TextField(blank=True, verbose_name="Description acuité visuelle avec correction")
    acuite_visuelle_cycloplefie = models.BooleanField(default=False, verbose_name="Acuité visuelle sous cyclopléfie")
    description_acuite_visuelle_cycloplefie = models.TextField(blank=True, verbose_name="Description acuité visuelle sous cyclopléfie")
    amplitude_accommodation = models.BooleanField(default=False, verbose_name="Amplitude d'accommodation")
    description_amplitude_accommodation = models.TextField(blank=True, verbose_name="Description amplitude d'accommodation")
    flexibilite_accommodative = models.BooleanField(default=False, verbose_name="Flexibilité accommodative")
    description_flexibilite_accommodative = models.TextField(blank=True, verbose_name="Description flexibilité accommodative")
    reponse_accommodative = models.BooleanField(default=False, verbose_name="Réponse accommodative")
    description_reponse_accommodative = models.TextField(blank=True, verbose_name="Description réponse accommodative")
    tests_muscles_oculomoteurs = models.BooleanField(default=False, verbose_name="Tests des muscles oculomoteurs")
    description_tests_muscles_oculomoteurs = models.TextField(blank=True, verbose_name="Description tests muscles oculomoteurs")
    cover_test = models.BooleanField(default=False, verbose_name="Cover test")
    description_cover_test = models.TextField(blank=True, verbose_name="Description cover test")
    heterophories = models.BooleanField(default=False, verbose_name="Hétérophories / Hétérotropies")
    description_heterophories = models.TextField(blank=True, verbose_name="Description hétérophories")
    vergences = models.BooleanField(default=False, verbose_name="Vergences")
    description_vergences = models.TextField(blank=True, verbose_name="Description vergences")
    test_maddox = models.BooleanField(default=False, verbose_name="Test du Maddox")
    description_test_maddox = models.TextField(blank=True, verbose_name="Description test du Maddox")
    test_worth = models.BooleanField(default=False, verbose_name="Test de Worth")
    description_test_worth = models.TextField(blank=True, verbose_name="Description test de Worth")
    stereoscopie = models.BooleanField(default=False, verbose_name="Stéréoscopie")
    description_stereoscopie = models.TextField(blank=True, verbose_name="Description stéréoscopie")
    keratometrie = models.BooleanField(default=False, verbose_name="Kératométrie")
    description_keratometrie = models.TextField(blank=True, verbose_name="Description kératométrie")
    keratometrie_od = models.CharField(max_length=50, blank=True, verbose_name="Kératométrie OD")
    keratometrie_og = models.CharField(max_length=50, blank=True, verbose_name="Kératométrie OG")
